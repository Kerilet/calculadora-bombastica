...
test('expect Konami Code easter egg to be fired ', () => {
  ...
  fireEvent.keyUp(app, { key: 'ArrowUp', code: 'ArrowUp', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowDown', code: 'ArrowDown', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowDown', code: 'ArrowDown', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowLeft', code: 'ArrowLeft', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowRight', code: 'ArrowRight', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowLeft', code: 'ArrowLeft', charCode: 13 });
  fireEvent.keyUp(app, { key: 'ArrowRight', code: 'ArrowRight', charCode: 13 });
  fireEvent.keyUp(app, { key: 'b', code: 'KeyB', charCode: 13 });
  fireEvent.keyUp(app, { key: 'a', code: 'KeyA', charCode: 13 });
  fireEvent.keyUp(app, { key: 'Enter', code: 'Enter', charCode: 13 });
